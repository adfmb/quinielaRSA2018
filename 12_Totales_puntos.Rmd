...
```{r}
datatable(gb_total%>%filter(grepl("A",Folio) | grepl("a",Folio)))#%>%select(-one_of(c("Pts x 1er Lugar","Pts x 2do Lugar","Pts x 3er Lugar"))))
# }else{
#   kable(tb1)
# }
```
...
```{r}
datatable(gb_total%>%filter(grepl("B",Folio) | grepl("b",Folio)))#%>%select(-one_of(c("Pts x 1er Lugar","Pts x 2do Lugar","Pts x 3er Lugar"))))
# }else{
#   kable(tb1)
# }
```
