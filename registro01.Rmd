...
3. Ingresa tu **nombre**, el **nombre de quien te invitó**, el **folio** que te fue proporcinado y **tu correo electrónico**. Posteriormente, ingresa a la pestaña [**Fase de grupos**](#Fase de grupos).

4. Comienza a llenar los marcadores de cada partido por grupos. En cada grupo debes dar clic en el botón de **ACTUALIZAR**.

5. Al terminar la *fase de grupos*, si llenaste y actualizaste todos los grupos, en automático se te mostrarán los equipos en la pestaña [**Octavos de Final**](#Octavos de Final). Llena tus resultados (sin empates), da **click en el botón para actualizar** y pasa a la siguiente fase.

6. A partir de allí, conforme vayas llenando cada fase y actualizando con su respectivo botón, podrás ir capturando tus pronósticos para las siguientes etapas ( [**Cuartos de Final**](#Cuartos de Final), [**Semifinales**](#Semifinales), [**Finales**](#Finales) ). 

7. En la última pestaña, [**Finales**](#Finales), después de ingresar tus predicciones para el partido por el tercer lugar y para la final, da clic en **¡TU GANADOR!** para que se desplieguen tus pronósticos para el primer, segundo y tercer lugar del mundial.
