                      ...
                      renderUI(
                        if(!is.null(lista2A()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")##,unique(lista2A()$data_EquipoPartido$Grupo),"!")
                          )
                        }
                      ),
         ...
         numericInput(paste0("E2",Grupo2),
                      renderUI(
                        if(!is.null(lista2B()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")##,unique(lista2B()$data_EquipoPartido$Grupo),"!")
                          )
                        }
                      ),
                      min=0, max=100, value=0,step=1,
         ...
         numericInput(paste0("E1",Grupo1),
                      renderUI(
                        if(!is.null(lista2C()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")##,unique(lista2C()$data_EquipoPartido$Grupo),"!")
                          )
                        }
                      ),
                      min=0, max=100, value=0,step=1,
         ...
         numericInput(paste0("E2",Grupo2),
                      renderUI(
                        if(!is.null(lista2D()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")##,unique(lista2D()$data_EquipoPartido$Grupo),"!")
                          )
                        }
                      ),
                      min=0, max=100, value=0,step=1,
         ...
         numericInput(paste0("E1",Grupo1),
                      renderUI(
                        if(!is.null(lista2E()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")##,unique(lista2E()$data_EquipoPartido$Grupo),"!")
                          )
                        }
                      ),
                      min=0, max=100, value=0,step=1,
         ...
         numericInput(paste0("E2",Grupo2),
                      renderUI(
                        if(!is.null(lista2F()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")##,unique(lista2F()$data_EquipoPartido$Grupo),"!")
                          )
                        }
                      ),
                      min=0, max=100, value=0,step=1,
         ...
         numericInput(paste0("E1",Grupo1),
                      renderUI(
                        if(!is.null(lista2G()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")##,unique(lista2G()$data_EquipoPartido$Grupo),"!")
                          )
                        }
                      ),
                      min=0, max=100, value=0,step=1,
         ...
         numericInput(paste0("E2",Grupo2),
                      renderUI(
                        if(!is.null(lista2H()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")##,unique(lista2H()$data_EquipoPartido$Grupo),"!")
                          )
                        }
                      ),
                      min=0, max=100, value=0,step=1,
         ...
         numericInput(paste0("E2",Grupo2),
                      renderUI(
                        if(!is.null(lista2G()$data_resumenEquipos)){
                          ...
                          tags$span(style="color:red",
                                   paste0("¡Aguas en Grupo!")###,unique(as.character(lista2G()$data_EquipoPartido$Grupo)),"!")
                          )
                        }
                      ),
                      min=0, max=100, value=0,step=1,
...
dataW<-reactive({data.frame("Codigo"=c(paste(Etapa,p,"E1",sep="_"),
                                       paste(Etapa,p,"E2",sep="_")),
