...
=======================================================================
[![](www/russia19.jpg){#id .class width=200 height=120px}](http://www.fifa.com/worldcup/)
<!-- ```{r fig.width=1.9, fig.height=1,echo=FALSE}
library(jpeg)
library(png)
library(grid)
img <- readJPEG("www/russia18.jpg")
...
<!-- renderGauge({ -->
<!--   rate <- 100*sum(c(vDownload$OK,vFinales$OK,vSemis$OK,v4s$OK,v8s$OK))/length(c(vDownload$OK,vFinales$OK,vSemis$OK,v4s$OK,v8s$OK)) -->
...
![](www/russia14.jpg){#id .class width=1150 height=240px}
...
fluidRow(
  ...
  # ),
  column(2, actionButton("buttonA", "Actualizar",  icon = icon("refresh"), 
...
fluidRow(
  column(2, actionButton("buttonB", "Actualizar",  icon = icon("refresh"), 
    style="color: #0066ff;background-image:-webkit-linear-gradient(#fff, #fff 60%, #f5f5f5)")
  ))
```
...
fluidRow(
  column(2, actionButton("buttonC", "Actualizar",  icon = icon("refresh"), 
    style="color: #0066ff;background-image:-webkit-linear-gradient(#fff, #fff 60%, #f5f5f5)")
  ))
```
...
fluidRow(
  column(2, actionButton("buttonD", "Actualizar",  icon = icon("refresh"), 
    style="color: #0066ff;background-image:-webkit-linear-gradient(#fff, #fff 60%, #f5f5f5)")
  ))
```
...
fluidRow(
  column(2, actionButton("buttonE", "Actualizar",  icon = icon("refresh"), 
    style="color: #0066ff;background-image:-webkit-linear-gradient(#fff, #fff 60%, #f5f5f5)")
  ))
```
...
fluidRow(
  column(2, actionButton("buttonF", "Actualizar",  icon = icon("refresh"), 
    style="color: #0066ff;background-image:-webkit-linear-gradient(#fff, #fff 60%, #f5f5f5)")
  ))
```
...
fluidRow(
  column(2, actionButton("buttonG", "Actualizar",  icon = icon("refresh"), 
    style="color: #0066ff;background-image:-webkit-linear-gradient(#fff, #fff 60%, #f5f5f5)")
  ))
```
...
fluidRow(
  column(2, actionButton(paste0("button",Grupo), "Actualizar",  icon = icon("refresh"), 
    style="color: #0066ff;background-image:-webkit-linear-gradient(#fff, #fff 60%, #f5f5f5)")
  ))
```
...
fluidRow(
  ...
  column(7,
         actionButton("buttonSemis","  NO TE VAYAS SIN ACTUALIZARME    :P",  icon = icon("refresh"), 
    style="color: #0066ff;background-image:-webkit-linear-gradient(#fff, #fff 60%, #f5f5f5)")
  ),
...
output$downloadData1 <- downloadHandler(
    filename = function() { 
      paste(Sys.time(),input$correo,"_",input$folio,'.csv', sep='') 
    },
